...
const std::string& toString(ErrorCode errorCode) noexcept {
    static const std::unordered_map<ErrorCode, std::string> errorCodeMap = {
        ...
        {ErrorCode::SSD_QUEUE_FULL, "SSD_QUEUE_FULL"},
        {ErrorCode::SSD_IO_TIMEOUT, "SSD_IO_TIMEOUT"},
        {ErrorCode::SSD_IO_SUBMIT_FAIL, "SSD_IO_SUBMIT_FAIL"},
        {ErrorCode::SSD_IO_RETRY_EXHAUSTED, "SSD_IO_RETRY_EXHAUSTED"},
